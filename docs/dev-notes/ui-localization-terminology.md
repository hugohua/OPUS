...
| 英文 | 中文 | 使用场景 | 备注 |
|------|------|----------|------|
| `MASTERED` / `Stable` | **已掌握** | 统计面板、详情操作、长文案 | 用户确认的词汇级状态；密集列表短标用“熟” |
| `LEARNING` | **学习中** | 词汇状态、筛选标签 | 正在习得阶段 |
| `REVIEW` / `Due` | **待复习** | 词汇状态、筛选标签 | 需要复习的项；密集列表短标用“复” |
| `NEW` | **新词** | 词汇状态、筛选标签 | 未开始学习；密集列表短标用“新” |
| `LEECH` | **难点词** | 词汇状态、筛选标签 | 反复出错的词；密集列表短标用“难” |
...
| 状态 | 短标签 | 使用场景 | 备注 |
|------|--------|----------|------|
| `MASTERED` | **熟** | `VocabListItemRow`、`VocabFilters` 紧凑筛选 | 表达“已掌握”，避免和英文单词行混排过长 |
| `NEW` | **新** | `VocabListItemRow` | 未开始学习 |
| `DUE` | **复** | `VocabListItemRow` | 到期复习 |
| `LEECH` | **难** | `VocabListItemRow` | 难点词 |
...
| `Mastered filter` | **熟** | VocabFilters |
...
| 2026-05-05 | v1.2 | 明确词汇级 MASTERED 长文案为“已掌握”，词库密集列表和筛选短标签使用“熟 / 新 / 复 / 难” |
