...
<output_schema>
Return strict JSON array. NO markdown wrapping. NO outer object wrapper.
[
  {
    "meta": {
      "format": "memo | email | chat",
      "target_word": "string",
    ...
    "segments": [
      ...
      },
      {
        ...
        "analysis": {
          ...
          "links": [
            { "from_chunk_id": 1, "to_chunk_id": 2, "reason": "关系代词 'who' 指代 'manager'，引导非限制性定语从句补充背景。" },
            { "from_chunk_id": 2, "to_chunk_id": 3, "reason": "从句结束（逗号后），回归主句谓语 'proposed'。" },
            { "from_chunk_id": 3, "to_chunk_id": 4, "reason": "及物动词 'proposed' 需接宾语 'a new strategy'。" },
            { "from_chunk_id": 4, "to_chunk_id": 5, "reason": "介词短语 'for...' 修饰 strategy，说明策略用途。" }
          ],
