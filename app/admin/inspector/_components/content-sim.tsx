...
export function ContentSimView() {
    return (
        <div className="flex-1 flex flex-col overflow-hidden bg-black">
            ...
            {/* Toolbar */}
            <div className="h-20 shrink-0 border-b border-white/10 flex items-center justify-between px-8 bg-zinc-900/50">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <button className="px-4 py-2 bg-white text-black text-xs font-bold rounded hover:bg-zinc-200">Reset Sim</button>
                </div>
            </div>

            {/* Content Table */}
            <div className="flex-1 overflow-y-auto p-8">
                <div className="w-full max-w-5xl mx-auto border border-white/10 rounded-xl overflow-hidden">

                    {/* Table Header */}
                    <div className="grid grid-cols-12 gap-4 p-3 bg-zinc-900 border-b border-white/10 text-[10px] font-mono text-zinc-500 uppercase tracking-wider">
                    ...
                    {/* Row 1: Optimal */}
                    <div className="grid grid-cols-12 gap-4 p-4 border-b border-white/5 bg-white/[0.02] items-center hover:bg-white/[0.05] transition-colors group">
                    ...
                    {/* Row 2: Warning */}
                    <div className="grid grid-cols-12 gap-4 p-4 border-b border-white/5 bg-amber-500/[0.05] items-center hover:bg-amber-500/[0.1] transition-colors group relative">
