            ...
            <div className="h-auto md:h-20 shrink-0 border-b border-border flex flex-col md:flex-row items-start md:items-center justify-between p-4 md:px-8 bg-muted/20 gap-4 md:gap-0">
                <div className="flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-6 w-full md:w-auto">
                    ...
                    <div className="flex items-center gap-1 bg-muted p-1 rounded-lg border border-border">
                        ...
                        <div className="px-4 text-xs font-mono text-muted-foreground">第 1 天</div>
                ...
                <div className="flex items-center justify-between w-full md:w-auto gap-4">
                    <div className="text-right flex-1 md:flex-none">
                        <div className="text-xs font-bold text-foreground">目标分数: 600</div>
                        <div className="text-[10px] text-muted-foreground">词汇覆盖率: 85%</div>
                    </div>
                    <button className="px-4 py-2 bg-foreground text-background text-xs font-bold rounded hover:opacity-90 whitespace-nowrap">重置模拟</button>
                </div>
            </div>
            ...
            <div className="flex-1 overflow-y-auto p-4 md:p-8">
                <div className="w-full max-w-5xl mx-auto border border-border rounded-xl overflow-hidden overflow-x-auto shadow-sm">
                    ...
                    <div className="min-w-[800px] grid grid-cols-12 gap-4 p-3 bg-muted/50 border-b border-border text-[10px] font-mono text-muted-foreground uppercase tracking-wider">
                        ...
                        <div className="col-span-3">难度评估</div>
                    ...
                    <div className="min-w-[800px] grid grid-cols-12 gap-4 p-4 border-b border-border bg-card items-center hover:bg-muted/50 transition-colors group">
                        ...
                        <div className="col-span-2 text-xs text-muted-foreground">名词</div>
                        ...
                        <div className="col-span-3">
                            <span className="px-2 py-1 rounded bg-emerald-500/10 text-emerald-500 text-[10px] font-bold border border-emerald-500/20">最优</span>
                        </div>
                    ...
                    <div className="min-w-[800px] grid grid-cols-12 gap-4 p-4 border-b border-border bg-amber-500/5 items-center hover:bg-amber-500/10 transition-colors group relative">
                        ...
                        <div className="col-span-2 text-xs text-muted-foreground">形容词</div>
                        <div className="col-span-2">
                            <div className="w-16 h-1.5 bg-muted rounded-full overflow-hidden">
                        ...
                        <div className="col-span-3">
                            <span className="px-2 py-1 rounded bg-amber-500/10 text-amber-500 text-[10px] font-bold border border-amber-500/20">超纲?</span>
                            <p className="text-[9px] text-muted-foreground mt-1">目标 600，这是 900 级词汇。</p>
                        </div>
                        <div className="col-span-1 text-right">
                            <button className="px-2 py-1 bg-amber-500 text-white text-[10px] font-bold rounded hover:bg-amber-600">降级</button>
                        </div>
                    </div>
                </div>
            </div>
